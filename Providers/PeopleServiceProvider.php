...
namespace Innerent\People\Providers;

use Illuminate\Database\Eloquent\Relations\Relation;
use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;
use Innerent\People\Contracts\User as UserContract;
use Innerent\People\Models\User;
use Innerent\People\Repositories\UserRepository;
...
class PeopleServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->app->make('router')->aliasMiddleware('auth', \Innerent\People\Http\Middleware\AuthMiddleware::class);
